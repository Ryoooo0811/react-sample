...
const ImageUploader = () => {
  ...
  const onChangeImage = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (files !== null && files.length > 0) {
      // fileRef.currentに値を保存す
      // file.Ref.currentが変化しても再描画は発生しない
  ...
  return (
    <div>
      ...
      <input type="file" ref={inputImageRef} accept="image/*" onChange={onChangeImage} style={{ visibility: 'hidden' }} />
      <br />
